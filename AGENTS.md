...
Guidance for AI coding agents working in this repository (Claude Code, GitHub Copilot, Cursor, Codex, etc.). `CLAUDE.md` and `.github/copilot-instructions.md` are symlinks to this file.
...
```
tidemill/
├── AGENTS.md                           # This file (CLAUDE.md and .github/copilot-instructions.md symlink here)
